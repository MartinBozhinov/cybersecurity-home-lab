...
Technique and CVE reference notes written in my own words while working through the
Assessment Methodologies material on the path to eJPT.

These are **general, publicly documented** techniques and public CVEs — no course
content, no real credentials, and all target addresses are placeholders
(`<TARGET_IP>`, `<LHOST>`).
...
| Note | Topic |
|---|---|
| [frequently-exploited-services.md](frequently-exploited-services.md) | Windows & Linux service reference |
...
| [cve/cve-2019-0708-bluekeep.md](cve/cve-2019-0